...
#fonksiyonin gorevi max alan ve max indisi bulmak
...
# görüntü webcam uzerinden alinir
cap = cv2.VideoCapture(0)

# while döngüsü ile frameler tek tek cekilir
while 1:
    ret, frame = cap.read()
    frame = cv2.flip(frame, 1)  # webcamden alinan görüntü kendi görüntümüz ise y eks. gore ceviriyoruz
